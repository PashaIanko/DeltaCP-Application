...
class Ui_SinusMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.EndlessSendingcheckBox, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.ResumeSendingradioButton, 1, 1, 1, 2)
